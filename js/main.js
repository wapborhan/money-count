...
function amount() {
  php5000 = document.getElementById("php_fivethousand").value;

  php1000 = document.getElementById("php_onethousand").value;

  php500 = document.getElementById("php_fivehundred").value;

  php100 = document.getElementById("php_hundred").value;

  php50 = document.getElementById("php_fifty").value;

  php20 = document.getElementById("twenty").value;

  php10 = document.getElementById("ten").value;

  php5 = document.getElementById("five").value;

  php2 = document.getElementById("two").value;

  php1 = document.getElementById("one").value;
...
function EnteredAmounts() {
  amt_enter = document.getElementById("amtenter").value;
  phil = amt_enter;
  if (amt_enter <= total) {
    subtotal = total - amt_enter;
    document.getElementById("Ent_Amounts").innerHTML = amt_enter;
    document.getElementById("tot_Amounts").innerHTML = total;
    document.getElementById("Balance").innerHTML = subtotal;
...
function GeneratingSlips() {
  ...
  document.getElementById("ammnt").innerHTML =
    "Total Ammount: <b>" + slip_tot + "</b>";
